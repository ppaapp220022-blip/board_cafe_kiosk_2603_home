...
-- ============================================================
-- 8. macro_message (1클릭 매크로 메시지)
-- ============================================================
INSERT INTO `macro_message` (`direction`, `message_text`, `is_active`)
VALUES ('TABLE_TO_STAFF', '직원 호출합니다.',          TRUE),
       ('TABLE_TO_STAFF', '물티슈 요청합니다.',         TRUE),
       ('TABLE_TO_STAFF', '게임 규칙 설명 부탁드립니다.', TRUE),
       ('TABLE_TO_STAFF', '테이블 청소 부탁드립니다.',   TRUE),
       ('STAFF_TO_TABLE', '잠시만 기다려 주세요.',       TRUE),
       ('STAFF_TO_TABLE', '주문하신 메뉴 나왔습니다.',   TRUE),
       ('STAFF_TO_TABLE', '이용 시간이 10분 남았습니다.', TRUE);
...
-- ============================================================
-- 11. game (보드게임 종목 — MenuService.getGameItems() 이름과 일치)
-- ============================================================
...
-- ============================================================
-- 12. game_item (실물 박스 재고 — status별 합산이 game별 stock)
-- ============================================================
...
-- ============================================================
-- 13. rental_log (게임 대여 이력 — 현재 대여 중인 RENTED 항목 반영)
-- ============================================================
