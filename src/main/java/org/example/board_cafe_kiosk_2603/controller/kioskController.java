...
import org.example.board_cafe_kiosk_2603.service.kiosk.MenuService;
...
public class kioskController {
    ...
    public String drinks(
        ...
        buildMenuModel(model, tableNumber, session, "drinks", menuService.getDrinkItems(), "음료");
    ...
    public String food(
            ...
            HttpSession session, Model model) {
        initSession(session, tableNumber);
        buildMenuModel(model, tableNumber, session, "food", menuService.getFoodItems(), "음식");
        return "layout/kiosk_layout";
    }
